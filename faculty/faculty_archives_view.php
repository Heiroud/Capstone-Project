  ...
  if(isset($_SESSION['session_faculty'])){
    ...
    ?>
      ...
      <head>
        ...
        <title> UI-ALPerf | Faculty | Archive View </title>
      ...
      <body>
        ...
        <main id="main" class="main">
          ...
          <section class="section report_view">
            <div class="row">
                    ...
                    <div class="row">
                      <?php
                        if(isset($_GET['report_stu_id']) && isset($_GET['report_ins_id'])){
                          ...
                          $select_stu_pts = mysqli_query($conn, "SELECT * FROM `class_report_stu` WHERE `report_stu_id` = '$stu_id' AND `faculty_id` = '$faculty_ID'");
                          ...
                          $select_ins_pts = mysqli_query($conn, "SELECT * FROM `class_report_ins` WHERE `report_ins_id` = '$ins_id' AND `faculty_id` = '$faculty_ID'");
